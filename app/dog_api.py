...
async def save_dog_record(payload, detected_emotion, confidence_emotion):
    try:
        ...
        # Else, create a new document for the dog, with dog_id as the id of the document
...
async def create_dog_record_api(payload: CreateDogSchema, background_tasks: BackgroundTasks):
    """
    ...
    try:
        ...
        # Start the background task to add dog record to firestore & image to GCS bucket
