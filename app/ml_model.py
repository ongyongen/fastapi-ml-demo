...
from app.constants import DOG_EMOTION_ML_MODEL_REF, DOG_EMOTION_MODEL_NAME, \
    DOG_EMOTION_MODEL_TYPE
...
async def lifespan(app: FastAPI):
    ...
    ml_models[DOG_EMOTION_ML_MODEL_REF] = pipeline(
        DOG_EMOTION_MODEL_TYPE,
        model=DOG_EMOTION_MODEL_NAME
    )
    yield
    ml_models.clear()
